...
drop table if exists holiday_map cascade;
create table if not exists holiday_map (
                             holiday_id bigint not null,
                             holiday_map_value date,
                             holiday_map_key date not null,
                             primary key (holiday_id, holiday_map_key)
);
...
alter table holiday_map
    add constraint FK382qrqgdu0atggreirpafufqf
